...
I used two classifiers: stochastic gradient boosting and random forest.  The random forest took noticeably longer to compute, but had perfect accuracy and performance.  Parameters used were 3-fold cross validated resampling (60/40 split).  With such high performance, I expected the results on the 20 records in the test set to be near-perfect accuracy.
